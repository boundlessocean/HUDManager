#
# Be sure to run `pod lib lint BLHUDManager.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'BLHUDManager/Classes/**/*'
  
  # s.resource_bundles = {
  #   'BLHUDManager' => ['BLHUDManager/Assets/*.png']
  # }
